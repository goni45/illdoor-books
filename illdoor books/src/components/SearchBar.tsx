...
export const SearchBar: React.FC<SearchBarProps> = ({
  ...
  const quickTags = [
    { label: '26653 Microprocessor', query: '26653' },
    { label: '26661 Database', query: '26661' },
    { label: '26454 Structure', query: '26454' },
    { label: '26761 AC Machine', query: '26761' },
    { label: '27051 Fluid Mech', query: '27051' },
    { label: '25931 Math-III', query: '25931' },
  ];
    ...
    <div className="w-full max-w-3xl mx-auto">
      ...
      >
        ...
        <input
          ...
          placeholder="বইয়ের নাম, লেখক অথবা বিষয় কোড দিয়ে খুঁজুন..."
      ...
      {showQuickTags && (
        <div className="mt-3 flex items-center gap-1.5 flex-wrap justify-center text-xs">
          <span className="text-neutral-500 font-medium mr-1">জনপ্রিয় বিষয় কোড:</span>
          {quickTags.map((tag) => (
            <button
              key={tag.query}
              type="button"
