...
export const RequestsPage: React.FC = () => {
  ...
  const handleSubmitRequest = async (e: React.FormEvent) => {
    ...
    if (!formData.title.trim()) {
      setFormError('দয়া করে বইয়ের নাম লিখুন');
      return;
    }
          ...
          <div className="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            <div className="max-w-2xl">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 backdrop-blur-md text-[#ef4d23] text-xs font-semibold uppercase tracking-wider mb-3">
                ...
                <span>বইয়ের চাহিদা ও রিকোয়েস্ট বোর্ড</span>
              </div>
              <h1 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold tracking-tight text-white leading-tight">
                প্রয়োজনীয় সিলেবাসের বই খুঁজে পাচ্ছেন না?
              </h1>
              <p className="mt-2 text-sm sm:text-base text-neutral-300">
                বিষয় কোড ও বাজেট দিয়ে অনুরোধ পোস্ট করুন। কোনো সহপাঠী বা সিনিয়রের কাছে বই থাকলে তারা দ্রুত ক্যাম্পাসে বিক্রির জন্য লিস্টিং দিতে পারবেন!
              </p>
            </div>
            ...
            >
              ...
              <span>বইয়ের জন্য অনুরোধ করুন</span>
            </button>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
          ...
          <div className="flex flex-wrap items-center gap-2.5">
            ...
            <div className="relative flex-1 sm:w-64">
              ...
              <input
                type="text"
                placeholder="বিষয় কোড বা বইয়ের নাম..."
                value={search}
        ...
        {loadingRequests ? (
          ...
          <div className="rounded-3xl border border-dashed border-neutral-300 bg-white/70 p-12 text-center my-6">
            ...
            <p className="text-sm text-neutral-500 max-w-md mx-auto mb-6">
              {activeTab === 'my'
                ? 'আপনার প্রয়োজনীয় কোনো নির্দিষ্ট বই বা নোট পেতে চান? একটি অনুরোধ তৈরি করুন, ক্যাম্পাসে পাওয়া গেলে আপনাকে জানানো হবে।'
            ...
            >
              <Plus className="w-4 h-4" />
              <span>বইয়ের অনুরোধ তৈরি করুন</span>
            </button>
          </div>
        ) : (
                  ...
                  <div className="pt-3 border-t border-neutral-100 mt-2">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      {isMine && req.maxBudget != null && (
                        <div className="text-right">
                          <span className="text-[10px] text-neutral-400 block font-medium">বাজেট</span>
                    ...
                    {isMine ? (
                      ...
                      >
                        <span>আমার কাছে এই বইটি আছে (বিক্রি করুন)</span>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="bg-white rounded-3xl max-w-lg w-full p-6 sm:p-8 shadow-2xl border border-neutral-200 relative animate-in zoom-in-95 duration-200 max-h-[90vh] overflow-y-auto">
            ...
            <div className="flex items-center gap-3 mb-5">
              ...
              <div>
                <h2 className="text-xl font-extrabold text-neutral-900">বইয়ের রিকোয়েস্ট তৈরি করুন</h2>
                <p className="text-xs text-neutral-500">
                  ক্যাম্পাসের শিক্ষার্থীদের জানান এবং বইটি লিস্টিং হওয়ার সাথে সাথে নোটিফিকেশন পান।
                </p>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmitRequest} className="space-y-4">
              ...
              <div>
                <label className="block text-xs font-bold text-neutral-700 mb-1.5">
                  বইয়ের নাম বা শিরোনাম *
                </label>
                <input
                  type="text"
                  placeholder="যেমন: ইলেকট্রিক্যাল সার্কিটস অ্যান্ড মেশিনস"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div>
                  <label className="block text-xs font-bold text-neutral-700 mb-1.5">ডিপার্টমেন্ট</label>
                  <select
                ...
                <div>
                  <label className="block text-xs font-bold text-neutral-700 mb-1.5">সেমিস্টার</label>
                  <select
              ...
              <div>
                <label className="block text-xs font-bold text-neutral-700 mb-1.5">
                  বিশেষ দ্রষ্টব্য / পছন্দের প্রকাশনী বা সংস্করণ (ঐচ্ছিক)
                </label>
                <textarea
                  rows={2}
                  placeholder="যেমন: ২০২২ প্রবিধানের বই দরকার। পাতা পরিষ্কার থাকলে ভালো হয়।"
