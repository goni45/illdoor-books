...
export const HomePage: React.FC = () => {
  ...
  const [filterDept, setFilterDept] = useState('Computer Science & Technology');
                ...
                <div className={`glass-card-white-inner rounded-xl sm:rounded-2xl p-3.5 sm:p-5 flex-col gap-2 sm:gap-3 shadow-xs relative ${mobileTab === 'matcher' ? 'flex' : 'hidden sm:flex'}`}>
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <div className="relative">
                      ...
                      >
                        <option value="Computer Science & Technology">Computer Science & Technology (85)</option>
                        <option value="Civil Technology">Civil Technology (64)</option>
                        <option value="Electrical Technology">Electrical Technology (67)</option>
                        <option value="Mechanical Technology">Mechanical Technology (70)</option>
                        <option value="Electronics Technology">Electronics Technology (68)</option>
                      </select>
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <div className="relative flex items-center border border-neutral-200/90 bg-white/95 rounded-lg px-3 py-1 focus-within:border-neutral-400 transition-colors shadow-xs">
                      ...
                      <input
                        ...
                        placeholder="e.g. 26642 / Data Structure"
