                    ...
                    <td className="py-3 px-2 text-right space-x-2">
                      ...
                      <button
                        onClick={() =>
                          updateBookStatus(
                            b.id,
                            b.availability === 'Available' ? 'Reserved' : 'Available'
                          )
                        }
                        className="text-amber-400 hover:text-amber-300 cursor-pointer"
                      >
                        {b.availability === 'Available' ? 'Pause' : 'Activate'}
                      </button>
                      <button
                        onClick={() => deleteBookListing(b.id)}
