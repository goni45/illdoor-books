...
export const ProfilePage: React.FC = () => {
  ...
  // My listings
  const myListings = books.filter((b) => b.seller.id === currentUser.id);
                  ...
                  <div className="flex flex-col gap-1.5 shrink-0">
                    ...
                    <button
                      onClick={() =>
                        updateBookStatus(
                          book.id,
                          book.availability === 'Available' ? 'Reserved' : 'Available'
                        )
                      }
                      className="px-2 py-1 rounded-lg text-[10px] font-semibold bg-neutral-100 hover:bg-neutral-200 text-neutral-700 cursor-pointer"
                    >
                      {book.availability === 'Available' ? 'Pause' : 'Activate'}
                    </button>
                    <button
                      onClick={() => deleteBookListing(book.id)}
