    ...
    >
      ...
      <div className="hidden md:flex items-center gap-4 lg:gap-6 text-[13px] lg:text-[14px] ml-3 lg:ml-5 font-medium text-neutral-800">
        ...
        <div className="relative" ref={dropdownRef}>
          ...
          {pagesDropdownOpen && (
            <div className="absolute top-full left-0 mt-3 w-48 bg-white rounded-2xl shadow-xl border border-neutral-200 p-2 z-50 animate-in fade-in slide-in-from-top-2 duration-150">
              <button
      ...
      {mobileMenuOpen && (
        <div
          id="mobile-dropdown"
          className="absolute top-full left-0 right-0 mt-2 bg-white/98 backdrop-blur-md rounded-2xl shadow-xl border border-neutral-200/90 p-3 z-30 flex flex-col gap-2 text-[14px] animate-in fade-in slide-in-from-top-2 duration-150"
        >
          ...
          {isAuthenticated ? (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-[11px] text-neutral-500 truncate">
                  {currentUser.department} • Roll #{currentUser.studentId}
                </p>
              </div>
            ...
            >
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <p className="text-xs font-bold text-neutral-900">লগইন বা রেজিস্টার</p>
                  <p className="text-[10px] text-neutral-500">বই কেনাবেচা করতে</p>
                </div>
              </div>
              <span className="text-xs text-[#ef4d23] font-semibold">লগইন →</span>
            </div>
          )}
